...
export function Emergency() {
  return (
    <section id="emergency" className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="relative overflow-hidden rounded-[2.5rem] bg-primary px-6 py-12 text-primary-foreground sm:px-12">
        ...
        <div className="relative grid items-center gap-8 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Button
                ...
                render={
                  <a href="tel:5551237297" className="flex items-center gap-2">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              { icon: Ambulance, title: "Emergency line", value: "Always answered" },
